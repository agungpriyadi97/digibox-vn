...
// CLICK ADD ADDRESS
//====================================================
WebUI.waitForElementClickable(findTestObject('WEB/Address/Add Address Delivery/btn_add_new_address'), 20)

WebUI.scrollToElement(findTestObject('WEB/Address/Add Address Delivery/btn_add_new_address'), 5)

WebUI.enhancedClick(findTestObject('WEB/Address/Add Address Delivery/btn_add_new_address'))
...
WebUI.mouseOver(findTestObject('Cammon/Address Form/input_TnhThnh Ph_el-input__inner'))
...
WebUI.mouseOver(findTestObject('Cammon/Address Form/input_PhngX_el-input__inner'))
